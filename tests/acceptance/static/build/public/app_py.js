...
// Transcrypt'ed from Python, 2017-09-06 00:27:30
function test () {
    ...
    */
	...
	(function () {
		var Main = __class__ ('Main', [object], {
			get test () {return __get__ (this, function () {
				print ('ola dsoadosa');
			});}
		});
		var Vue = __class__ ('Vue', [object], {
			get __init__ () {return __get__ (this, function (self, proto) {
				self.proto = proto;
			});}
		});
		var app = Vue (dict ({'el': '#app', 'data': dict ({'message': 'Hello Vue'})}));
		__pragma__ ('<all>')
			__all__.Main = Main;
			__all__.Vue = Vue;
			__all__.app = app;
